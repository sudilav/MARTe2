...
bool LoggerConsumerITest::TestPrintToStream() {
    ...
    if (ok) {
        ...
        if (sizeof(void *) == 8u) {
            expectedPrint = "|Debug|1000000000|0:2:3 (1000000000)|Obj1|0x00000000AABBCCDD|LoggerConsumerITest||TestPrintToStream|LoggerConsumerITest.cpp:163|LoggerConsumerITest::TestPrintToStream";
        }
        else {
            expectedPrint = "|Debug|1000000000|0:2:3 (1000000000)|Obj1|0xAABBCCDD|LoggerConsumerITest||TestPrintToStream|LoggerConsumerITest.cpp:163|LoggerConsumerITest::TestPrintToStream";
        }
...
bool LoggerConsumerITest::TestPrintToStream_WithKeys() {
    ...
    if (ok) {
        ...
        if (sizeof(void *) == 8u) {
            expectedPrint =
                    "|E=Debug|TM=1000000000|TM=0:2:3 (1000000000)|o=Obj1|O=0x00000000AABBCCDD|C=LoggerConsumerITest|T=|f=TestPrintToStream|F=LoggerConsumerITest.cpp:163|D=LoggerConsumerITest::TestPrintToStream";
        }
        else {
            expectedPrint =
                    "|E=Debug|TM=1000000000|TM=0:2:3 (1000000000)|o=Obj1|O=0xAABBCCDD|C=LoggerConsumerITest|T=|f=TestPrintToStream|F=LoggerConsumerITest.cpp:163|D=LoggerConsumerITest::TestPrintToStream";
        }
        ok = (err == expectedPrint);
    }
